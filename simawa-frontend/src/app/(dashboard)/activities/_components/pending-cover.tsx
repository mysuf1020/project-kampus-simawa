        ...
        {isError && (
          <div className="rounded-lg border border-amber-100 bg-amber-50 p-3 text-center">
            <p className="text-xs font-medium text-amber-800">
              Fitur ini hanya tersedia untuk BEM/DEMA Admin
            </p>
          </div>
        )}
            ...
            >
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-2 text-xs text-neutral-500">
                  <Badge
                    variant="outline"
                    className="text-[10px] py-0 h-5 border-neutral-200 text-neutral-600"
                  >
                    {activity.status || 'PENDING'}
                  </Badge>
                  <span>•</span>
                  <span>
                    {activity.cover_key ? 'Sampul terlampir' : 'Belum ada sampul'}
                  </span>
                </div>
              </div>
