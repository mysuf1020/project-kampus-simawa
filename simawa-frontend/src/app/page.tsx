        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto space-y-8">
            ...
            <p className="text-lg text-neutral-600 leading-relaxed max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom-8 duration-900">
              Platform terintegrasi untuk manajemen surat, proposal kegiatan, laporan
              pertanggungjawaban, dan keanggotaan organisasi mahasiswa.
            </p>
            ...
            <div className="flex items-center justify-center gap-4 pt-4 animate-in fade-in slide-in-from-bottom-10 duration-1000">
              <Link href="/login">
                <Button
                  size="lg"
                  className="h-12 px-8 bg-brand-600 hover:bg-brand-700 text-white text-base shadow-lg shadow-brand-500/20 rounded-full"
                >
                  Mulai Sekarang
                </Button>
              </Link>
              <Link href="/public">
                <Button
                  size="lg"
                  variant="outline"
                  className="h-12 px-8 border-neutral-200 text-neutral-700 hover:bg-neutral-50 bg-white rounded-full"
                >
                  Jelajahi Publik
                </Button>
              </Link>
        ...
        <Container>
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-neutral-600">
              Fitur lengkap untuk mendukung produktivitas organisasi mahasiswa dalam satu
              platform.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="group bg-white p-8 rounded-3xl border border-neutral-200 shadow-sm hover:shadow-lg hover:shadow-brand-500/5 hover:-translate-y-1 transition-all duration-300"
              >
          ...
          <div className="bg-brand-900 rounded-[2.5rem] p-12 md:p-20 text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto space-y-8">
              <h2 className="text-3xl md:text-5xl font-bold text-white tracking-tight">
                Siap Memajukan Organisasi Anda?
              </h2>
              <p className="text-brand-100 text-lg leading-relaxed">
                Bergabunglah dengan SIMAWA dan rasakan kemudahan dalam mengelola
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                <Link href="/login">
                  <Button
                    size="lg"
                    className="h-14 px-8 bg-white text-brand-900 hover:bg-brand-50 font-semibold rounded-full text-base w-full sm:w-auto"
                  >
                    Masuk ke Dashboard
                  </Button>
                </Link>
